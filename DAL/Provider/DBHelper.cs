...
namespace DAL.Provider
{
    public class DBHelper
    {
        ...
        private static readonly string S_CONNECTION = ConfigurationManager.ConnectionStrings["DBR_CON"].ConnectionString;
        private static readonly string S_PROVIDER =   ConfigurationManager.ConnectionStrings["DBR_CON"].ProviderName;
